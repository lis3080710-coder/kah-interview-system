...
function EvaluationDetailsModal({ candidate, onClose }) {
          ...
          <div key={idx} className="bg-gray-50 rounded-xl p-4 mb-3 border border-gray-200">
            <div className="flex justify-between items-center mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs text-gray-400 font-semibold">면접관 ID</div>
                  <div className="text-xs text-[#1e3a5f] font-semibold font-mono">
